...
# 天工造文 (SkyCraft Novel AI) - 企业级前后端分离版 (v2.4 Admin Pro)
...
**v2.4 更新：后台管理系统大幅增强，新增用户CRUD功能与可视化 API 实验室。**
...
2.  **Users (用户管理) - [NEW]**
    *   **用户列表**: 查看所有注册用户。
    *   **新增用户**: 管理员可手动创建测试账号。
    *   **存档审计**: 点击“存档”按钮可查看该用户的所有小说项目，包括流派、设定和更新时间。
    *   **重置密码**: 忘记密码时，管理员可直接重置指定用户的密码。
    *   **违规处理**: 级联删除用户及其所有存档数据。
...
### 4. 退出登录
点击侧边栏顶部的用户名旁的“退出”按钮，系统将清除本地凭证并立即返回登录界面。

---

## 📝 版本历史 (Changelog)

**v2.4.3 (UX Improvement)**
*   **体验**: 优化了“退出登录”的逻辑，现在点击退出会平滑切换回登录页，而不会触发布局抖动或页面重载。

**v2.4.2 (Admin Archives)**
*   **功能**: 后台管理系统新增“查看用户存档”功能。
*   **UI**: 优化用户列表操作栏布局。
