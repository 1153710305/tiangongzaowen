...
# 天工造文 (SkyCraft Novel AI) - 企业级前后端分离版 (v2.5.1)
...
**v2.5.1 更新：新增“爆款仿写模式”，支持输入竞品小说信息，AI 自动拆解爆火基因并生成新创意。**
...
4.  **API Lab (实验室) - [NEW]**
    ...
    *   **[v2.5.1] 分析模式测试**: 支持构造 `analysis_idea` 请求，验证仿写逻辑。
...
*   **爆款仿写模式**：[NEW] 适合分析竞品，输入你想模仿的小说书名和简介（支持多个），AI 会自动拆解其成功逻辑并生成新的变种创意。
...
*   **Feature**: 新增“爆款仿写/分析模式”，支持输入参考小说列表。
*   **Prompt**: 新增 `ANALYSIS_IDEA` 提示词逻辑。
*   **Admin**: API Lab 增加分析模式测试模板。
