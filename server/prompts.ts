...
**生成要求**：
1. **书名**：必须符合"${platform}"平台的取名套路，具有强烈的网文风格，吸睛，包含核心梗或金手指。
2. **简介**：必须符合"${platform}"平台的简介风格，必须是“新媒体爆款文案”风格。前三句必须抛出冲突、悬念或金手指。
3. **爽点/爆点**：必须精准击中"${platform}"读者的核心爽点，明确指出读者的情绪价值来源（如：人前显圣、极致反差），指出核心冲突的高潮点或反转点。
