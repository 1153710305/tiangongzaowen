                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6">
                    ...
                    {!showCardHistory && (
                        <>
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                     <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider">项目列表</h3>
                    ...
                    {showCardHistory && (
                        <div className="space-y-4 animate-fade-in">
                            {savedCards.map(card => (
                                <div key={card.id} className="bg-paper border border-slate-700 rounded-lg p-3 relative group hover:border-pink-500/50 transition-colors">
                                    <button 
                                    ...
                                    <div className="flex gap-1 flex-wrap">
                                        <span className="text-[10px] bg-indigo-900/40 text-indigo-300 px-1.5 py-0.5 rounded border border-indigo-500/30">爽点</span>
                                        <span className="text-[10px] bg-red-900/40 text-red-300 px-1.5 py-0.5 rounded border border-red-500/30">爆点</span>
                                    </div>
                                </div>
                            ))}
                            {savedCards.length === 0 && (
                                ...
                                {draftCards.map((draft, idx) => (
                                    <div key={idx} className="bg-slate-800 border border-slate-700 rounded-xl p-5 shadow-lg flex flex-col relative overflow-hidden group hover:border-pink-500 transition-colors">
                                        ...
                                        <div className="space-y-2 mb-4 text-xs">
                                            ...
                                            <div className="bg-black/20 p-2 rounded border border-slate-700/50">
                                                <span className="text-yellow-400 font-bold block mb-1">✨ 金手指</span>
                                                <span className="text-slate-400">{draft.golden_finger}</span>
                                            </div>
                                        </div>
